...
//    public ReqRes signUp(OurUsers user) {
//        ReqRes response = new ReqRes();
//
//        if (ourUserRepo.findByEmail(user.getEmail()).isPresent()) {
//            response.setStatusCode(HttpStatus.BAD_REQUEST.value());
//            response.setError("L'email existe déjà.");
//            return response;
//        }
//
//        // Encode the password
...
//        response.setMessage("Utilisateur inscrit avec succès.");
//        return response;
//    }
